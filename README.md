...
| **[ScreenWeaver](https://github.com/GOOD-123-CPU/screenweaver)** | 配置驱动的数据大屏：Vue 3、TypeScript 与 ECharts | [完整配置示例](https://github.com/GOOD-123-CPU/screenweaver/blob/main/public/configs/city-ops.json) · [数据接入](https://github.com/GOOD-123-CPU/screenweaver/blob/main/docs/data-integration.md) |
